...
- source code: [nextjs](https://github.com/RetricSu/offckb/tree/master/templates/next-js-template/frontend)
- source code: [remix-vite](https://github.com/RetricSu/offckb/tree/master/templates/remix-vite-template/frontend)
