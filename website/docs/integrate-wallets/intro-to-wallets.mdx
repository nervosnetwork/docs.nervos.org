...
CKB address packages the [Lock Script](/docs/tech-explanation/glossary#lock-script) into a single line of verifiable and human-readable format, adhering to Bitcoin's [Bech32m address format (BIP-350)](https://github.com/sipa/bips/blob/bip-bech32m/bip-0350.mediawiki).
