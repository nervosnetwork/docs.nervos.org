...
A single Cell requires at least 61 bytes of storage, equivalent to [61 CKBytes (CKB)](/docs/tech-explanation/capacity-mini). Allocating **62 CKB** is recommended to cover additional fees in practice.
