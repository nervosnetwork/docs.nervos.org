...
For detailed specifications, refer to [CKB Address](/docs/ckb-fundamentals/ckb-address) in the Tech Explanation.
...
A single Cell requires at least 61 bytes of storage, equivalent to [61 CKBytes (CKB)](/docs/tech-explanation/capacity#capacity-mini). Allocating **62 CKB** is recommended to cover additional fees in practice.
