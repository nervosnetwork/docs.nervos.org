...
In the *Network* dropdown menu you can switch to other networks such as the Aggron testnet or the CKB mainnet. Switching the network will stop your currently running instance.
