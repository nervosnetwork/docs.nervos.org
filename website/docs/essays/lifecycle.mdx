...
The process of verification involves checking the [following items](https://github.com/nervosnetwork/ckb/blob/92b3bcadc019b0d7ecb46bbd82a890f123cf2c35/verification/src/block_verifier.rs#L38):       
```
