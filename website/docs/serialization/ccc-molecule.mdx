...
The full code of this tutorial is available on [GitHub](https://github.com/nervosnetwork/docs.nervos.org/tree/master/examples/ccc-molecule)
...
Check the [full code](https://github.com/nervosnetwork/docs.nervos.org/tree/master/examples/ccc-molecule/src/full-example.ts) for the game example.
