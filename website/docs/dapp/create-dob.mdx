...
[Spore](/docs/tech-explanation/spore-protocol) is an on-chain <Tooltip>digital object (DOB)</Tooltip> protocol backed by CKB. An “on-chain” asset refers to a digital asset with its data directly encoded on the blockchain. A Spore Cell can hold any type of asset users want to store on-chain. The data structure for a Spore Cell is as follows:
...
<SwitchToTestnet readmeLink="https://github.com/nervosnetwork/docs.nervos.org/tree/master/examples/dApp/create-dob" />

## Additional Resources

- [Spore Protocol High-Level Explanation](/docs/tech-explanation/spore-protocol)
