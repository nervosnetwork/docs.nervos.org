...
<CodeTabs
  cmd={`make build`}
  response={`docs.nervos.org/examples/dApp/simple-lock/rust-simple-lock$ make build 
Cleaning build/release directory...
mkdir -p build/release
make[1]: Entering directory 'docs.nervos.org/examples/dApp/simple-lock/rust-simple-lock/contracts/hash-lock'
RUSTFLAGS="-C target-feature=+zba,+zbb,+zbc,+zbs,-a -C debug-assertions" TARGET_CC="clang-19" TARGET_AR="llvm-ar-19" \
        cargo build --target=riscv64imac-unknown-none-elf --release 
   ...
   Compiling hash-lock v0.1.0 (docs.nervos.org/examples/dApp/simple-lock/rust-simple-lock/contracts/hash-lock)
    Finished \`release\` profile [optimized + debuginfo] target(s) in 14.21s
Copying binary hash-lock to build directory
make[1]: Leaving directory 'docs.nervos.org/examples/dApp/simple-lock/rust-simple-lock/contracts/hash-lock'`}
/>

Once compiled, the contract binary will be output to the `examples/dApp/simple-lock/scripts` directory.
...
<CodeTabs
  cmd={`pnpm install
pnpm build`}
  response={`docs.nervos.org/examples/dApp/simple-lock/ts-simple-lock$ pnpm install
...
docs.nervos.org/examples/dApp/simple-lock/ts-simple-lock$ pnpm build

> @ build docs.nervos.org/examples/dApp/simple-lock/ts-simple-lock
> pnpm -r run build
...
│ > simple-lock@0.1.0 copy-js-vm-script docs.nervos.org/examples/dApp/simple-lock/ts-simple-lock/packages/on-chain-script-tests
...
Once compiled, the contract files will be available in the `examples/dApp/simple-lock/scripts` directory as well.
...
<SwitchToTestnet readmeLink="https://github.com/nervosnetwork/docs.nervos.org/tree/master/examples/dApp/simple-lock" />
