...
In this tutorial, you will learn how to create a full-stack dApp, including both the frontend and the <Tooltip>Script</Tooltip>, to deepen your understanding of CKB blockchain development.
...
:::tip
For production smart contract development, we recommend using [**Rust**](/docs/script/rust/rust-quick-start) due to its performance, memory safety, and mature tooling support. Check out the [Rust version of this example](/docs/script/rust/rust-example-simple-lock) to see the same functionality implemented in Rust.
:::
...
- [**Rust Example: Simple Lock**](/docs/script/rust/rust-example-simple-lock) — The same functionality implemented in Rust
