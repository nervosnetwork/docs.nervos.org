...
:::note
This toy lock example isn't intended for production. Use it ONLY in Testnet or Devnet as an starting point for learning the basics.
:::
...
Once compiled, the contract files will be available in the `examples/simple-lock/dist` directory.
