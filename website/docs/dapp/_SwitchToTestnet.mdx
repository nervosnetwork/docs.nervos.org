...
Acutally, we have the corresponding Testnet version examples for all these tutorials. The source code of the Testnet version is in [https://github.com/nervosnetwork/docs.nervos.org/tree/develop-v2/examples](https://github.com/nervosnetwork/docs.nervos.org/tree/develop-v2/examples), you can clone the repo and start running on Testnet.
...
For more details, check out the [README.md](https://github.com/nervosnetwork/docs.nervos.org/blob/develop-v2/examples/simple-transfer/README.md);
