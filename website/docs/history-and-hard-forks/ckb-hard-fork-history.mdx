...
## 2nd Hard Fork – CKB Edition Meepo (2024) {#meepo-hardfork}
...
Below is a comprehensive checklist for updating tools, libraries, and SDKs related to the Meepo hardfork. If you rely on any of these, we recommend upgrading to a recent version with the minimum recommended specified below.

#### CKB Node

- CKB Binary for Testnet: [v0.119.0](https://github.com/nervosnetwork/ckb/releases/tag/v0.119.0)
- CKB Binary for Mainnet: [v0.200.0](https://github.com/nervosnetwork/ckb/releases/tag/v0.200.0)

#### Core Components

- ckb (crate): [v0.119.0](https://crates.io/crates/ckb-verification/0.119.0)
- ckb-vm: [v0.24.12](https://github.com/nervosnetwork/ckb-vm/releases/tag/v0.24.12)

#### Standard Libraries

- ckb-std: [v0.16.1](https://github.com/nervosnetwork/ckb-std/releases/tag/v0.16.1)
...
- ckb-rust-sdk: [v3.4.1](https://github.com/nervosnetwork/ckb-sdk-rust/releases/tag/v3.4.1)
- ckb-go-sdk: [v2.3.0](https://github.com/nervosnetwork/ckb-sdk-go/releases/tag/v2.3.0)
- ckb-sdk-java: [v3.0.0](https://github.com/nervosnetwork/ckb-sdk-java/releases/tag/rc%2Fv3.0.0)
- ckb-sdk-js: [v0.109.2](https://github.com/ckb-js/ckb-sdk-js/releases/tag/v0.109.2)
- CCC (the new recommended ckb js sdk): [v0.0.2](https://github.com/ckb-devrel/ccc/releases/tag/v0.0.2)
- lumos (another ckb js sdk): [v0.24.0-next.2](https://github.com/ckb-js/lumos/releases/tag/v0.24.0-next.2)

#### Development Tools

- ckb-cli: [v1.6.0](https://github.com/nervosnetwork/ckb-cli/releases/tag/v1.6.0)
- ckb-testtool: [v0.14.0](https://github.com/nervosnetwork/ckb-testtool/releases/tag/v0.14.0)
- ckb-standalone-debugger: [v0.119.0](https://github.com/nervosnetwork/ckb-standalone-debugger/releases/tag/v0.119.0)
...
## 1st Hard Fork – CKB Edition Mirana (2021) {#mirana-hardfork}
