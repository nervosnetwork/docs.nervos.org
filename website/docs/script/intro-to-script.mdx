...
In most cases, Lock Script and Type Script function similarly. The only key takeaway is that, the Lock Script attached to the output Cells will not execute in a transaction.
