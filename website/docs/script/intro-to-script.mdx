...
In most cases, Lock Script and Type Script function similarly. The only key takeaway is that, the Lock Scripts attached to the output Cells will not execute in a transaction.
