...
| 0       | 2072       | [ckb_load_header](https://github.com/nervosnetwork/rfcs/blob/master/rfcs/0009-vm-syscalls/0009-vm-syscalls.md#load-header)                                                                     | Serialize the specified header associated with an input Cell, dep Cell, or header dep using the Molecule Encoding 1 format and copy it using partial loading. For unconfirmed Cells supplied by the tx-pool, the syscall returns `CKB_ITEM_MISSING` instead of aborting.                                        |
...
| 2       | 2104       | [ckb_load_extension](https://github.com/nervosnetwork/rfcs/blob/master/rfcs/0050-vm-syscalls-3/0050-vm-syscalls-3.md#load-block-extension)                                                     | Load the extension field data and copy it using partial loading. For unconfirmed Cells supplied by the tx-pool, the syscall returns `CKB_ITEM_MISSING` instead of aborting.                                                                                                                                     |
