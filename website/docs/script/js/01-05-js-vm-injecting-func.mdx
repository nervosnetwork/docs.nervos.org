...
You can refer to [Examples/call-syscalls](https://01-github.com/nervosnetwork/ckb-js-vm/tree/main/examples/call-syscalls), which contains a JS script that can be executed directly inside the JS-VM:
