...
Here's a basic unit test for a [`hello-world`](https://github.com/nervosnetwork/docs.nervos.org/tree/v2/examples/rust-script-examples/contracts/hello-world) contract:
...
- [`Loader::default().load_binary()`](https://github.com/nervosnetwork/docs.nervos.org/blob/v2/examples/rust-script-examples/tests/src/tests.rs#L13) loads the contract binary. [`Loader`](https://github.com/cryptape/ckb-script-templates/blob/main/workspace/tests/src/lib.rs#L38) is provided by `ckb-script-templates`, but you can implement your own loader, for example using [`include_bytes!`](https://github.com/nervosnetwork/ckb-auth/blob/main/tests/auth-c-tests/src/lib.rs#L46).
