...
:::note
In `ckb-script-templates`, `debug-assertions` is enabled by default. To disable it, comment out the line `CUSTOM_RUSTFLAGS := -C debug-assertions` in the contract's [`Makefile`](https://github.com/nervosnetwork/docs.nervos.org/blob/v2/examples/rust-script-examples/contracts/log/Makefile#L9).
:::
...
[Code](https://github.com/nervosnetwork/docs.nervos.org/blob/v2/examples/rust-script-examples/contracts/log/src/main.rs#L25-L29)
