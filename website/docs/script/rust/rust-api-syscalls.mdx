...
See the example in <ExampleLink path="ckb-rust-script/contracts/tx-hash">ckb-rust-script/tx-hash</ExampleLink>. It demonstrates how to get the `tx_hash`, pass it through the witness, and verify it.
...
See the example in <ExampleLink path="ckb-rust-script/contracts/script-hash">ckb-rust-script/script-hash</ExampleLink>:
