...
This section introduces the simplest contract, "Hello World," covering ([Code](https://github.com/nervosnetwork/docs.nervos.org/tree/v2/examples/rust-script-examples/contracts/hello-world)):
...
Upon successful execution, a Rust project will be created in the `rust-script-examples` directory ([Example](https://github.com/nervosnetwork/docs.nervos.org/tree/v2/examples/rust-script-examples/)). The generated project includes:
...
:::
This command creates a `hello-world` subproject inside the `contracts` directory and automatically adds a `test_hello_world` function in [`tests/src/tests.rs`](https://github.com/nervosnetwork/docs.nervos.org/blob/v2/examples/rust-script-examples/tests/src/tests.rs#L10-L58).

The contract's entry function, `program_entry` (similar to `main` in Rust), is located in [`contracts/hello-world/src/main.rs`](https://github.com/nervosnetwork/docs.nervos.org/blob/v2/examples/rust-script-examples/contracts/hello-world/src/main.rs).
...
Real-world contracts often need to access transaction information or on-chain data. To build on the previous example, this section covers ([Code](https://github.com/nervosnetwork/docs.nervos.org/tree/v2/examples/rust-script-examples/contracts/simple-print-args)).
...
Modify [`main.rs`](https://github.com/nervosnetwork/docs.nervos.org/blob/v2/examples/rust-script-examples/contracts/simple-print-args/src/main.rs#L18):
