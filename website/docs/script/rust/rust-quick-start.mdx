...
Upon successful execution, a Rust project will be created in the `ckb-rust-script` directory ([Example](https://github.com/nervosnetwork/docs.nervos.org/tree/v2/examples/rust-script-examples/)). The generated project includes:
