...
:::note
Note that the variants of `SysError` do not correspond one-to-one with the raw [syscall return codes](https://github.com/nervosnetwork/ckb/blob/v0.120.0/script/src/syscalls/mod.rs#L57).
