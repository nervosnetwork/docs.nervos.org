...
See the example at [`rust-script-examples/error`](https://github.com/nervosnetwork/docs.nervos.org/tree/v2/examples/rust-script-examples/contracts/error).
This is a _Lock Script_ that uses `args[0]` to select which error type to trigger.
You can verify the behavior with the tests in [`tests/src/test_error.rs`](https://github.com/nervosnetwork/docs.nervos.org/blob/v2/examples/rust-script-examples/tests/src/tests_error.rs).
