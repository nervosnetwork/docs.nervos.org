...
We introduced [**Build a Simple Lock**](../../dapp/simple-lock) in the dApp tutorial. The dApp tutorial demonstrates how to build a full-stack application with a Rust contract and a web frontend. Here, we'll dive deeper into the Rust contract implementation itself.
...
See [**Build a Simple Lock**](../../dapp/simple-lock). The Rust version works the same way in the frontend.
