---
id: rust-example-spawn-script
title: "Example: Spawn Script"
---
...
The full code of this tutorial can be found at [Github](https://github.com/nervosnetwork/docs.nervos.org/tree/master/examples/spawn-script).
...
- Full source code of this tutorial:
  [spawn-script](https://github.com/nervosnetwork/docs.nervos.org/tree/master/examples/spawn-script)
