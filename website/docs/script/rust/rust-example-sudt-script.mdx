...
The full code of the UDT Script in this tutorial can be found at [Github](https://github.com/nervosnetwork/docs.nervos.org/tree/master/examples/sudt-script).
...
The sUDT Script is implemented in [contracts/sudt/src/main.rs](https://github.com/nervosnetwork/docs.nervos.org/tree/master/examples/sudt-script/contracts/sudt/src/main.rs). This script is designed to manage the transfer of UDTs on the CKB blockchain.
...
Full code: [contracts/sudt/src/main.rs](https://github.com/nervosnetwork/docs.nervos.org/tree/master/examples/sudt-script/contracts/sudt/src/main.rs)
...
For owner mode test case, refer to the [full tests code](https://github.com/nervosnetwork/docs.nervos.org/tree/master/examples/sudt-script/contracts/sudt/tests/src/tests.rs) for reference.
...
- Full source code of this tutorial:
  [sudt-script](https://github.com/nervosnetwork/docs.nervos.org/tree/master/examples/sudt-script)
