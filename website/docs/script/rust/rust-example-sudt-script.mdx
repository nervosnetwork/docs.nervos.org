---
id: rust-example-sudt-script
title: "Example: Simple UDT"
---
...
In this tutorial, we will create a UDT Script, a simplified version of [XUDT standard](/docs/ecosystem-scripts/xudt)
...
The full code of the UDT Script in this tutorial can be found at <ExampleLink path="ckb-rust-script/contracts/sudt">Github</ExampleLink>.
...
Now, let's create a new project to build the UDT Script. We will use [ckb-script-templates](https://github.com/cryptape/ckb-script-templates).
...
The sUDT Script is implemented in <ExampleLink path="ckb-rust-script/contracts/sudt/src/main.rs#L37">`contracts/sudt/src/main.rs`</ExampleLink>. This script is designed to manage the transfer of UDTs on the CKB blockchain.
...
Full code: <ExampleLink path="ckb-rust-script/contracts/sudt/src/main.rs">`contracts/sudt/src/main.rs`</ExampleLink>
...
For owner mode test case, refer to the <ExampleLink path="ckb-rust-script/tests/src/test_sudt.rs">full tests code</ExampleLink> for reference.
...
- Full source code of this tutorial:
  <ExampleLink path="ckb-rust-script/contracts/sudt">sudt-script</ExampleLink>
