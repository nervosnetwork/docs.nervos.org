...
The mechanisms behind `spawn` and IPC are described in detail in [ckb-script-ipc](./ckb-script-ipc). This section focuses only on the related APIs.
...
[A Simplified IPC Solution](http://localhost:3000/docs/script/ckb-script-ipc#introducing-ckb-script-ipc-a-simplified-ipc-solution)
