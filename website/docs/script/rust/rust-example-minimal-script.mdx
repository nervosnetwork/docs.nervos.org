...
Below is a step-by-step guide, and you can also clone the full code example from the Github at <ExampleLink path="ckb-rust-script/contracts/carrot">carrot-script</ExampleLink>.
...
- Full source code of this tutorial: <ExampleLink path="ckb-rust-script/contracts/carrot">carrot-script</ExampleLink>
