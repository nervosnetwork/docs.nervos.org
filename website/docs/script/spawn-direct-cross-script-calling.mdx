...
The diagram below illustrates inter-process communication and scheduling. The example code is from the rust-script-examples [spawn-parent](https://github.com/nervosnetwork/docs.nervos.org/blob/v2/examples/rust-script-examples/contracts/spawn-parent/src/main.rs) and [spawn-child](https://github.com/nervosnetwork/docs.nervos.org/blob/v2/examples/rust-script-examples/contracts/spawn-parent/src/main.rs).
