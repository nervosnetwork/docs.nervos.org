...
- [Exec](https://github.com/nervosnetwork/rfcs/blob/master/rfcs/0034-vm-syscalls-2/0034-vm-syscalls-2.md#exec) is deprecated and not recommended to use in the VM 1. Under VM 1, the `exec` syscall can cause unexpected behavior theoretically. However, this issues is not existed in VM 2.
