...
2. 10 [MOPs](https://en.wikipedia.org/wiki/Micro-operation_fusion) added:
...
- [VM Version](https://github.com/nervosnetwork/rfcs/blob/master/rfcs/0034-vm-syscalls-2/0034-vm-syscalls-2.md#vm-version)
- [Current Cycles](https://github.com/nervosnetwork/rfcs/blob/master/rfcs/0034-vm-syscalls-2/0034-vm-syscalls-2.md#current-cycles)
- [Exec](https://github.com/nervosnetwork/rfcs/blob/master/rfcs/0034-vm-syscalls-2/0034-vm-syscalls-2.md#exec)

Full description: [RFC](https://github.com/nervosnetwork/rfcs/blob/master/rfcs/0034-vm-syscalls-2/0034-vm-syscalls-2.md)

### Cost Model

- For all B instructions, 1 cycle will be consumed.
- 10 [MOPs](https://en.wikipedia.org/wiki/Micro-operation_fusion) cycle cost:
...
- [Exec](https://github.com/nervosnetwork/rfcs/blob/master/rfcs/0034-vm-syscalls-2/0034-vm-syscalls-2.md#exec) is deprecated and not recommended for use in VM 1. Under VM 1, the `exec` syscall can cause unexpected behavior theoretically. However, this issue does not exist in VM 2.
...
5 [MOPs](https://en.wikipedia.org/wiki/Micro-operation_fusion) added:
...
- 5 [MOPs](https://en.wikipedia.org/wiki/Micro-operation_fusion) cycle cost:
