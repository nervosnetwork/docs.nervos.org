...
export const ScriptHeaders: ScriptHeadersType = {
  ...
  typeid: {
    ...
    topics: [
      {
        label: "Type-ID",
        link: "https://github.com/nervosnetwork/rfcs/blob/master/rfcs/0022-transaction-structure/0022-transaction-structure.md#type-id",
      },
      { label: "Script", link: "/docs/tech-explanation/script" },
      {
        label: "Transaction",
  ...
  sudt: {
    ...
    topics: [
      {
        label: "UDT",
        link: "https://github.com/nervosnetwork/rfcs/blob/master/rfcs/0025-simple-udt/0025-simple-udt.md",
      },
      { label: "Script", link: "/docs/tech-explanation/script" },
      {
        label: "Transaction",
