...
![btc-script-interpreter](/img/ckb-vs-btc/btc-script-interpreter.gif)
...
<img
  src="/img/ckb-vs-btc/ckb-locking-script.png"
  width="688px"
  height="281px"
...
<img
  src="/img/ckb-vs-btc/ckb-unlocking-script.png"
  width="732px"
  height="379px"
...
- If the previous`result` equals 8, the Script returns `0`
