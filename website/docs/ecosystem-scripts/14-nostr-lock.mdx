...
- If PoW difficulty ≠ 0: The public key hash is not used and should be all zero, and another unlock method, [NIP-13](https://github.com/nostr-protocol/nips/blob/master/13.md), is used
