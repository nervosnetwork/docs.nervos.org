...
DNA should be stored in the `content` field of the [Spore](/docs/ecosystem-scripts/spore-protocol#spore):
...
Pattern is the common data for a set of DOBs specified when creating the [Spore Cluster](/docs/ecosystem-scripts/spore-protocol#cluster). It is parsed in the DOB/0 decoder as a JSON array:
...
The decoder interprets `DNA` and `Pattern`, specified when the [Spore Cluster](/docs/ecosystem-scripts/spore-protocol#cluster) is released. The configuration is a JSON object encoded in UTF-8:
...
| code_hash | 0x13cac78ad8482202f18f9df4ea707611c35f994375fa03ae79121312dda9925c |
| hash_type | data1                                                              |
| tx_hash   | 0xf6ebcf3881b9ffe64e94f4ee2f643cfc69515faba1dadf4a9e4a7d3f9ecc4094 |
| index     | 0x0                                                                |
| dep_type  | code                                                               |
