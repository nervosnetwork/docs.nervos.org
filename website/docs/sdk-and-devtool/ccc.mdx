...
CCC also serves as a [wallet connector](/integrate-wallets/ccc-wallet.md) enhancing interoperability between wallets across different blockchains. Explore by checking out the [CCC Demo](https://app.ckbccc.com/).
