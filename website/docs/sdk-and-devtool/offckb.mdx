...
The boilerplate supports multiple CKB networks. For more details, see [Switch Between Different Networks](/docs/getting-started/ckb-networks#switch-between-different-networks).
