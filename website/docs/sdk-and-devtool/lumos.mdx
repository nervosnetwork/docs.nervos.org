...
Lumos is no longer actively recommended for new projects. For a more robust development experience, consider using [Common Chain Connector (CCC)](https://docs.nervos.org/docs/sdk-and-devtool/ccc) — the preferred JavaScript/TypeScript SDK for building on CKB.
