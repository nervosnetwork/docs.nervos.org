...
<img alt="Three States of CKBytes" src={useBaseUrl("img/mining/mining-different-state.png")} width="100%"/>
...
<img alt="Secondary Issuance Allocation" src={useBaseUrl("img/mining/mining-allocation.png")} width="100%"/>
...
<img alt="charts_secondary-issuance" src={useBaseUrl("img/mining/secondary-issuance.png")} width="100%"/>
