...
Lastly, we do the signing and witness data part, just like what we mentioned in the previous tutorial in the [Transfer CKB](/docs/dapp-tutorials/transfer-ckb) example:
