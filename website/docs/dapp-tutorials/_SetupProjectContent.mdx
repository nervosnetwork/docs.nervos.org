...
To interact with the dApp, you need to have your Devnet running. After installing [@offckb/cli](https://www.npmjs.com/package/@offckb/cli), open one terminal and start the Devnet:
