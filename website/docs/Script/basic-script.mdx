...
As we have learned before, a script returns 0 means it succeeds. A simplest CKB script code looks like this in Rust:
...
Below is a step by step guide, you can also clone the full code example from github [carrot-script](https://github.com/nervosnetwork/docs.nervos.org/tree/develop/examples/carrot-script).
