...
If you’re simply looking to connect to an existing public RPC node (e.g. for dApp development or testing), check out this [rpc guide](/docs/getting-started/rpcs).
