...
If you're using a Unix-like system, run `./ckb init --chain mainnet` instead.
...
3. Search your node ID on [Node Probe](https://nodes.ckb.dev) and you should be prompted that your node is connectable and visible on the network.
