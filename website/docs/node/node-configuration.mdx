...
Starting in [CKB v0.202.0](https://github.com/nervosnetwork/ckb/releases/tag/v0.202.0), a new `HolePunching` protocol is enabled by default in `support_protocols`.
...
- No manual configuration is needed if you're running **CKB v0.202.0 or later** — the protocol is already included by default in the `support_protocols` list.
