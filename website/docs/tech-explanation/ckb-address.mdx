...
See how one key combined with different Script references produce multiple addresses:

<video
  src="/video/craft_ckb_demo.mp4"
  width="688px"
  height="327px"
  controls
  poster="/images/ckb_addr_demo_cover.png"
></video>

Try this interactive demo: [Craft CKB Address](https://craft-ckb-address.vercel.app).