...
An address is a long string of numbers and letters that serves as the destination for a blockchain transaction.
...
- By default, each transaction uses a different address.
- This minimizes address reuse and makes transaction histories more difficult to correlate.
