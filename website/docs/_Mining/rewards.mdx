...
<img alt="Three States of CKBytes" src={useBaseUrl("img/mining/mining 1 mining-different-state.png")} width="50%"/>
...
<img alt="Secondary Issuance Allocation" src={useBaseUrl("img/mining/mining 2 mining-allocation.png")} width="50%"/>
...
<img alt="charts_secondary-issuance" src={useBaseUrl("img/mining/mining 3 explorer.nervos.org_charts_secondary-issuance.png")} width="50%"/>
