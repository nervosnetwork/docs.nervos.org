...
Nervos uses the Eaglesong hashing algorithm, and mining CKB today requires specialized ASIC miners. In the past, GPUs and FPGA miners were used, but since March 2020 CKB mining has gradually shifted to ASICs. While GPU and FPGA mining is still technically possible, it is no longer efficient or profitable compared to ASICs.

<img
  alt="mining hardware"
  src={"/img/mining/change-in-ckb-mining.png"}
  width="688"
/>

You can acquire CKB miners from platforms such as [estripe.com](http://estripe.com/), [Bitmain Official Store](https://shop.bitmain.com/?coin=CKB), [Wyminer](https://www.wyminer.com/), and [Newegg](https://www.newegg.com/).
