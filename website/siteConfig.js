...
const siteConfig = {
  ...
  headerLinks: [
    { doc: "docs/dapp/view-and-transfer-balance", label: "Dapp" },
    { doc: "docs/dev-environment", label: "Dev Environment" },
    { doc: "docs/ecosystem", label: "Ecosystem" },
    { doc: "docs/rpcs", label: "RPCs" },
    { doc: "docs/concept/cell-model", label: "Concepts" },
    { doc: "docs/contract/coming-soon", label: "Contract" },
  ],
