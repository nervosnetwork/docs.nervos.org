    ...
    },
    {
      ...
      items: [
        "common-scripts/introduction",
        {
          ...
          collapsed: true,
          items: [
            "common-scripts/secp256k1_blake160_sighash_all",
            "common-scripts/secp256k1_blake160_multisig_all",
            "common-scripts/nervos-dao",
            "common-scripts/lock-proxy-lock",
            "common-scripts/input-type-proxy-lock",
            "common-scripts/output-type-proxy-lock",
            "common-scripts/single-use-lock",
            "common-scripts/time-lock",
            "common-scripts/type-burn-lock",
            "common-scripts/easy-to-discover-type",
            "common-scripts/xudt",
            "common-scripts/omnilock",
            "common-scripts/anyone-can-pay",
            "common-scripts/nostr-lock",
            "common-scripts/nostr-binding",
            "common-scripts/ccc-btc-lock",
            "common-scripts/ccc-eth-lock",
            "common-scripts/ccc-sol-lock",
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            "common-scripts/ckb-auth",
            "common-scripts/ckb-crypto-service",
          ],
        },
      ],
    },
