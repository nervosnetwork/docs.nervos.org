...
root@0d31cad7a539:/code# ./build/native_args_assembler -f udt.js -t d7b0fea7c1527cde27cc4e7a2e055e494690a384db14cc35cd2e51ec6f078163
...
> const Uint128LE = require("@ckb-lumos/codec").number.Uint128LE;
> txSkeleton.update("outputs", (outputs) => {
  let cell = outputs.first();
