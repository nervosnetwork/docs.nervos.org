...
export default function WalletCard({ title, href, tags, size = 'default', className }: WalletCardProps): JSX.Element {
            ...
            <div className={styles.rightContainer}>
                ...
                {size === 'default' &&
                 <div className={styles.tags}>
                    {tags.map((tag, index) => <p key={index} className={styles.tag}>{tag}</p> )}
                </div>
                }
            </div>
       </Link>
