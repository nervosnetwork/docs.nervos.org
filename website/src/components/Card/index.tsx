...
export default function Card({ title, description, link, type, links, internal = true, className }: CardProps): JSX.Element {
    ...
    return (
       <Link href={link} target="_blank" rel="noopener noreferrer" className={clsx(styles.cardContainer, className)}>
            <CardContent {...props} />
       </Link>
    );
}
